...
// Use the available window, so tablets and split-screen resize automatically.
const _railBreakpoint = 600.0;
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        void onSelect(int i) =>
            ref.read(dashboardSelectedTabProvider.notifier).state = i;
          ...
          return Scaffold(
            ...
            floatingActionButton:
                isLandscape
                    ? Builder(
                      builder:
                          (fabContext) => FloatingActionButton.small(
